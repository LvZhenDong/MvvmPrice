...
public class ViewModelScope {
  ...
  public <T extends ViewModel> T getParentFragmentScopeViewModel(@NonNull Fragment parentFragment, @NonNull Class<T> modelClass) {
    if (mParentFragmentProvider == null) mParentFragmentProvider = new ViewModelProvider(parentFragment);
